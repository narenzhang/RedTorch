...
public class OrderReq  implements Serializable{
	...
	public String toString() {
		return "OrderReq [gatewayID=" + gatewayID + ", symbol=" + symbol + ", exchange=" + exchange + ", rtSymbol="
				...
				+ offset + ", priceType=" + priceType + ", originalOrderID=" + originalOrderID + ", productClass=" + productClass
				+ ", currency=" + currency + ", expiry=" + expiry + ", strikePrice=" + strikePrice + ", optionType="
				+ optionType + ", lastTradeDateOrContractMonth=" + lastTradeDateOrContractMonth + ", multiplier="
				+ multiplier + "]";
	}
	@Override
	public int hashCode() {
