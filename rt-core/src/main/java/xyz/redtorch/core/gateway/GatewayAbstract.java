...
public abstract class GatewayAbstract implements Gateway{
	...
	public void emitTrade(String gatewayID, String symbol, String exchange, String rtSymbol, String tradeID, String rtTradeID,
		...
		try {
			FastEvent fastEvent = ringBuffer.get(sequence); // Get the entry in the Disruptor for the sequence
			fastEvent.getTrade().setAllValue(gatewayID, symbol, exchange, rtSymbol, tradeID, rtTradeID, orderID, rtOrderID, originalOrderID, direction, offset, price, volume, tradingDay, tradeDate, tradeTime, dateTime);
	...
	public void emitOrder(String gatewayID, String symbol, String exchange, String rtSymbol, String orderID, String rtOrderID,
		...
		try {
			FastEvent fastEvent = ringBuffer.get(sequence); // Get the entry in the Disruptor for the sequence
			fastEvent.getOrder().setAllValue(gatewayID, symbol, exchange, rtSymbol, orderID, rtOrderID, direction, offset, price, totalVolume, tradedVolume, status, tradingDay, orderDate, orderTime, cancelTime, activeTime, updateTime, frontID, sessionID,originalOrderID);
